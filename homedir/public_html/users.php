...
<div class="pt-list">
	<div class="pt-title">
		<span><i class="fas fa-users"></i></span> <b><?=$lang['userspage']['title']?></b>
	</div>
	<div class="pt-u">
	<?php
		...
		<div class="pt-list-item">
			<div class="media">
				<div class="media-left">
					<div class="pt-thumb"><img src="<?=$rs['photo']?>" alt="<?=$rs['username'] ?>_avatar" onerror="this.src='<?=nophoto?>'"></div>
				</div>
				<div class="media-body">
					...
					<p>
						...
						<span><?=db_rows("families WHERE author = '{$rs['id']}'")?> <?=$lang['userspage']['families']?></span>
					</p>
				</div>
			</div>
		</div>
