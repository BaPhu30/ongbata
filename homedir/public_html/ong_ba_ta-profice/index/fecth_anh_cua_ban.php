...
if ($userid == $id_khach) {
    ...
    $query = "SELECT *,SUBSTRING(`url`, 48), @rank :=  @rank + 1 AS rank_av FROM ftree_v1_4_gallery g, (SELECT  @rank := 0) r where membersid  = '{$membersid}' and typefile = 'normal_photo' ORDER BY g.id DESC;";
            ...
            <div class="col pd_5 md-width_50">
                        <div class="position-relative height_100">
                                                                        ...
                                                                        data-bs-target="#myModal1" >
                                                                            ...
                                                                            <img src="<?php echo $row['url'] ?>"  style="height: 250px;" class="rounded-3 " alt="" data-bs-target="#carouselExampleCaptions"
