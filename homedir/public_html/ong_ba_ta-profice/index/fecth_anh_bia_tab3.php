...
if ($userid == $id_khach) {
   ...
   $delete="xoa_dulieu";
                                            ...
                                            $query = "SELECT *, SUBSTRING(`url`, 1, 47), SUBSTRING(`url`, 48), @rank :=  @rank + 1 AS rank_ab  FROM ftree_v1_4_gallery g , (SELECT  @rank := 0) r where membersid  = '{$membersid}' and typefile = 'cover_image' ORDER BY g.id DESC";
